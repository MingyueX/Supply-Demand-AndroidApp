...
import com.zh.testbottonnav.AttrList;
import com.zh.testbottonnav.OnClickListenerWrapper;
import com.zh.testbottonnav.R;
import com.zh.testbottonnav.ScreeningActivity;
import com.zh.testbottonnav.ui.AutoMeasureHeightGridView;

import java.util.ArrayList;
import java.util.List;

public class RSslipAdapter extends SimpleBaseAdapter<AttrList.Attr> {
    public RSslipAdapter(Context context, List<AttrList.Attr> data) {
        super(context, data);
    }
    ...
    private void fillLv2CateViews(final AttrList.Attr mAttr, List<AttrList.Attr.Vals> list,
        ...
        mChildAdapter.setTitle(mAttr.getKey());
